...
export function BookmarkButton({ bookCode, chapter, verse, text }: BookmarkButtonProps) {
  ...
  return (
    <>
      <button
        onClick={handleClick}
        className="p-1 rounded hover:bg-[var(--muted)] text-[var(--muted-foreground)] hover:text-[var(--accent)] transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
