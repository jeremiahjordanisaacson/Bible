...
import joshuaChapter1Verses from './sample-joshua-1';
import joshuaChapter24Verses from './sample-joshua-24';
import judgesChapter6Verses from './sample-judges-6';
import ruthChapter1Verses from './sample-ruth-1';
import ruthChapter4Verses from './sample-ruth-4';
import samuel1Chapter3Verses from './sample-1samuel-3';
import samuel2Chapter7Verses from './sample-2samuel-7';
import kings1Chapter18Verses from './sample-1kings-18';
import ezraChapter1Verses from './sample-ezra-1';
import nehemiahChapter8Verses from './sample-nehemiah-8';
import estherChapter4Verses from './sample-esther-4';
import jobChapter1Verses from './sample-job-1';
import jobChapter38Verses from './sample-job-38';
import psalmChapter1Verses from './sample-psalm-1';
import psalmChapter23Verses from './sample-psalm-23';
import psalmChapter51Verses from './sample-psalm-51';
import psalmChapter103Verses from './sample-psalm-103';
import psalmChapter139Verses from './sample-psalm-139';
import proverbsChapter1Verses from './sample-proverbs-1';
import proverbsChapter31Verses from './sample-proverbs-31';
import ecclesiastesChapter1Verses from './sample-ecclesiastes-1';
import ecclesiastesChapter12Verses from './sample-ecclesiastes-12';
import songChapter1Verses from './sample-song-1';
import isaiahChapter6Verses from './sample-isaiah-6';
import isaiahChapter9Verses from './sample-isaiah-9';
import isaiahChapter40Verses from './sample-isaiah-40';
import isaiahChapter53Verses from './sample-isaiah-53';
import jeremiahChapter1Verses from './sample-jeremiah-1';
import jeremiahChapter31Verses from './sample-jeremiah-31';
import lamentationsChapter3Verses from './sample-lamentations-3';
import ezekielChapter37Verses from './sample-ezekiel-37';
import danielChapter7Verses from './sample-daniel-7';
import hoseaChapter11Verses from './sample-hosea-11';
import joelChapter2Verses from './sample-joel-2';
import amosChapter5Verses from './sample-amos-5';
import jonahChapter2Verses from './sample-jonah-2';
import micahChapter6Verses from './sample-micah-6';
import habakkukChapter3Verses from './sample-habakkuk-3';
import zechariahChapter9Verses from './sample-zechariah-9';
import malachiChapter3Verses from './sample-malachi-3';
...
registerChapter('Josh.1', joshuaChapter1Verses);
registerChapter('Josh.24', joshuaChapter24Verses);
registerChapter('Judg.6', judgesChapter6Verses);
registerChapter('Ruth.1', ruthChapter1Verses);
registerChapter('Ruth.4', ruthChapter4Verses);
registerChapter('1Sam.3', samuel1Chapter3Verses);
registerChapter('2Sam.7', samuel2Chapter7Verses);
registerChapter('1Kgs.18', kings1Chapter18Verses);
registerChapter('Ezra.1', ezraChapter1Verses);
registerChapter('Neh.8', nehemiahChapter8Verses);
registerChapter('Esth.4', estherChapter4Verses);
registerChapter('Job.1', jobChapter1Verses);
registerChapter('Job.38', jobChapter38Verses);
registerChapter('Psa.1', psalmChapter1Verses);
registerChapter('Psa.23', psalmChapter23Verses);
registerChapter('Psa.51', psalmChapter51Verses);
registerChapter('Psa.103', psalmChapter103Verses);
registerChapter('Psa.139', psalmChapter139Verses);
registerChapter('Prov.1', proverbsChapter1Verses);
registerChapter('Prov.31', proverbsChapter31Verses);
registerChapter('Eccl.1', ecclesiastesChapter1Verses);
registerChapter('Eccl.12', ecclesiastesChapter12Verses);
registerChapter('Song.1', songChapter1Verses);
registerChapter('Isa.6', isaiahChapter6Verses);
registerChapter('Isa.9', isaiahChapter9Verses);
registerChapter('Isa.40', isaiahChapter40Verses);
registerChapter('Isa.53', isaiahChapter53Verses);
registerChapter('Jer.1', jeremiahChapter1Verses);
registerChapter('Jer.31', jeremiahChapter31Verses);
registerChapter('Lam.3', lamentationsChapter3Verses);
registerChapter('Ezek.37', ezekielChapter37Verses);
registerChapter('Dan.7', danielChapter7Verses);
registerChapter('Hos.11', hoseaChapter11Verses);
registerChapter('Joel.2', joelChapter2Verses);
registerChapter('Amos.5', amosChapter5Verses);
registerChapter('Jonah.2', jonahChapter2Verses);
registerChapter('Mic.6', micahChapter6Verses);
registerChapter('Hab.3', habakkukChapter3Verses);
registerChapter('Zech.9', zechariahChapter9Verses);
registerChapter('Mal.3', malachiChapter3Verses);
